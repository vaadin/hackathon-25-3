...
[`45-older-behaviours.zip`](https://github.com/vaadin/hackathon-25-3/raw/1e50ad1f28e0c668ef34f8a87d9cec8ad8ab4626/specs/issues/projects/45-older-behaviours.zip), then `mvn test`. Two tests, both passing, and both passing is the finding: navigating twice builds the view once, and the constraint message is English.
...
[`45-older-behaviours.zip`](https://github.com/vaadin/hackathon-25-3/raw/1e50ad1f28e0c668ef34f8a87d9cec8ad8ab4626/specs/issues/projects/45-older-behaviours.zip), 5 KB, sources only. Unzip it and:
