...
public class GridView extends VerticalLayout {
    ...
    public GridView() {
        setSizeFull();
        // Exactly what an application with a runtime theme switcher does: no
        // @Theme anywhere, one stylesheet added by hand at startup.
        com.vaadin.flow.component.UI.getCurrent().getPage()
                .addStyleSheet(com.vaadin.flow.theme.lumo.Lumo.STYLESHEET);
