...
public class DiagnosticsView extends VerticalLayout {
    ...
    private Div kitPanel(java.util.Locale locale) {
        ...
        // One under another, each across the whole panel. It was two columns
        // for a while, on a typographic argument about reading measure, and
        // the answer to that argument is that a panel of numbers with prose
        // flowing in columns in the middle of it reads as a magazine rather
        // than as a screen.
